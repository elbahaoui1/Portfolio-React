          ...
          <div class="p-card-content">
            <div>
              ...
              <ul>
                <li>
                  Delphi/Pascal</li>
                <li>FirdBird/IBExpert</li>
                <li>Programmable Logical Controllers (PLCs)</li>
                <li>Protocols and Networkig</li>
              </ul>
            </div>
          </div>
          <div class="p-card-footer">
            aout 2022 - Septembre 2022</div>
        </div>
      </div>
